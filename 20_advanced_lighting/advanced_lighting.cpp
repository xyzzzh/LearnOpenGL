//
// Created by Chamelz on 2022/12/1.
//
#include <glad/glad.h>
...
int main()
{
    ...
    // -------------------------
    Shader shader("../shaders/20_v.glsl", "../shaders/20_f.glsl");
    ...
    // load texture
    // ------------
    unsigned int floorTexture = loadTexture(RESOURCES_ROOT_PATH"/textures/wood.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.setMat4("view", view);// set light uniforms
...
void panel() {
    ...
    if(ImGui::BeginMenu("lighting_mode")){
        if (ImGui::MenuItem("Blinn_Phong")){
            mode = 0;
        }
