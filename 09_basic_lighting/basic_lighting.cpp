...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("../shaders/09_01_v.glsl", "../shaders/09_01_f.glsl");
    Shader lightCubeShader("../shaders/09_02_v.glsl", "../shaders/09_02_f.glsl");
...
void set_UI(){
    ...
    ImGui::ColorEdit3("objectColor", (float *) &objectColor); // Edit 3 floats representing a color
