...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("../shaders/08_01_v.glsl", "../shaders/08_01_f.glsl");
    Shader lightCubeShader("../shaders/08_02_v.glsl", "../shaders/08_02_f.glsl");
...
void set_UI(){
    ...
    ImGui::SliderFloat("camera.Position.x", &camera.Position.x, 0.0f, 5.0f);
    ImGui::SliderFloat("camera.Position.y", &camera.Position.y, 0.0f, 5.0f);
    ImGui::SliderFloat("camera.Position.z", &camera.Position.z, 0.0f, 10.0f);
