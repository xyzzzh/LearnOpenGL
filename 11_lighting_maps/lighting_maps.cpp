...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("../shaders/11_01_v.glsl", "../shaders/11_01_f.glsl");
    Shader lightCubeShader("../shaders/11_02_v.glsl", "../shaders/11_02_f.glsl");
    ...
    // -----------------------------------------------------------------------------
    unsigned int diffuseMap = loadTexture(RESOURCES_ROOT_PATH "/container2.png");
    unsigned int specularMap = loadTexture(RESOURCES_ROOT_PATH "/container2_specular.png");
