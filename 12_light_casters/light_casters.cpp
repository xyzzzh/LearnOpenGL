...
// lighting
ImVec4 lightPos(1.2f, 1.0f, 2.0f, 1.0f);
...
void UI();
void basic_Editor_UI();
void material_Editor_UI();
void light_Editor_UI();
...
int main() {
    ...
    // ------------------------------------
    Shader lightingShader("../shaders/12_01_v.glsl", "../shaders/12_01_f.glsl");
    Shader lightCubeShader("../shaders/12_02_v.glsl", "../shaders/12_02_f.glsl");
...
void material_Editor_UI() {
    ...
    ImGui::Begin("material_Editor"); // Create a window called "Hello, world!" and append into it.
...
void light_Editor_UI() {
    ...
    ImGui::Begin("light_Editor"); // Create a window called "Hello, world!" and append into it.

    ImGui::Text("Light properties:");
    ImGui::SliderFloat("lightPos.x", &lightPos.x, -10.0f, 10.0f);
    ImGui::SliderFloat("lightPos.y", &lightPos.y, -10.0f, 10.0f);
    ImGui::SliderFloat("lightPos.z", &lightPos.z, -10.0f, 10.0f);
