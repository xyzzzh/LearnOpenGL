//
// Created by Chamelz on 2022/11/10.
//
#include <glad/glad.h>
...
int main()
{
    ...
    // -------------------------
    Shader shader("../shaders/14_v.glsl", "../shaders/14_f.glsl");
...
void UI() {
    ...
    if (ImGui::Button("GL_LESS")) // Buttons return true when clicked (most widgets return true when edited/activated)
        glDepthFunc(GL_LESS);
    ImGui::SameLine();
    if (ImGui::Button("GL_ALWAYS")) // Buttons return true when clicked (most widgets return true when edited/activated)
